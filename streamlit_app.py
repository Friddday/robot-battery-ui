...
// 1회차 학습 버튼은 데모에서 가장 중요한 CTA라서,
// 상위 이벤트 위임이나 장식 레이어와 충돌해도 동작하도록 직접 클릭 이벤트를 한 번 더 연결합니다.
const learnBtnDirect=$("learnBtn");
if(learnBtnDirect){
  learnBtnDirect.addEventListener("click",(event)=>{
